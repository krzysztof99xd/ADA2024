...
if __name__ == '__main__':
    ...
    create_subscription("ada2024-413110", "diabetes_res", "diabetes_res_sub")
    pull_message(project="ada2024-413110", subscription="diabetes_res_sub")  # replace ada2023 with your project id
